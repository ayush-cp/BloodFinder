...
const handleContactChange = (e)=>{
  ...
  <div className="container">
    ...
    <form className="registration-form" onSubmit={handleSubmit}>
      ...
      <label>
        Contact no.:
       <input type="tel" placeholder='Enter contact number' id="contact" value={contact} onChange={handleContactChange} minLength="10" maxLength="10" required/>
      </label>
      </div>
      <label>
        State:
        <select name="selectState" id="selectState" value={stateChoice} required onChange={e=>setStateChoice(e.target.value)}>
      ...
      <label>
        District:
        <select name="district" value={districtSelected} onChange={e=>setDistrictSelected(e.target.value)}  required>
      ...
      <label>
        Blood Group:
        <select name="bloodGroup" value={blood} onChange={e=>setBlood(e.target.value)} required>
